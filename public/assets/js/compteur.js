...
var texte = '<div class="container"><h2>Prochain événement dans :</h2><div id="countdown" class="countdown container"><div class="row"><div class="countdown-item col-sm-3 col-xs-6"><div id="countdown-days" class="countdown-number">'+ d_restants+'</div><div class="countdown-label">jours</div></div><div class="countdown-item col-sm-3 col-xs-6"><div id="countdown-hours" class="countdown-number">'+H_restantes+'</div><div class="countdown-label">heures</div></div><div class="countdown-item col-sm-3 col-xs-6"><div id="countdown-minutes" class="countdown-number">'+i_restantes+'</div><div class="countdown-label">minutes</div></div><div class="countdown-item col-sm-3 col-xs-6"><div id="countdown-seconds" class="countdown-number">'+s_restantes+'</div><div class="countdown-label">secondes</div></div></div></div></div>';
